...
namespace DuiLib {
    ...
    bool CDPI::StripDPIInfo(const base::String& name, base::String& newName) {
        ...
        base::String str = name.Mid(lastSplitPos + 1, lastPotPos - lastSplitPos - 1);
    ...
    bool CDPI::AddAPIInfo(const base::String& name, int dpi, base::String& newName) {
        int lastPotPos = name.ReverseFind(TEXT('.'));
