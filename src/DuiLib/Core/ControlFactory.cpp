...
namespace DuiLib {
    ...
    CControlFactory::CControlFactory() {
        ...
        INNER_REGISTER_DUICONTROL(CWkeUI);
    ...
    CControlUI *CControlFactory::CreateControl(base::String strClassName) {
    ...
    void CControlFactory::RegistControl(base::String strClassName, CreateClass pFunc) {
        strClassName.MakeLower();
