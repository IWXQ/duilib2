...
namespace DuiLib {
	...
	public:
		...
		// 用户属性
		virtual const base::String& GetUserData(); // 辅助函数，供用户使用
		...
		base::String GetVirtualWnd() const;
	...
	protected:
		...
		TCHAR m_chShortcut;
		base::String m_sUserData;
		UINT_PTR m_pTag;

		base::String m_sGradient;
		DWORD m_dwBackColor;
		DWORD m_dwBackColor2;
		DWORD m_dwBackColor3;
		DWORD m_dwForeColor;
		base::String m_sBkImage;
		base::String m_sForeImage;
