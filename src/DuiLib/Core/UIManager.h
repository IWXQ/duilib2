...
#define UISTATE_CAPTURED     0x00000040
	...
	public:
		...
		static base::String GetInstancePath();
		static base::String GetCurrentPath();
		static HINSTANCE GetResourceDll();
		static const base::String& GetResourcePath();
		static const base::String& GetResourceZip();
		static const base::String& GetResourceZipPwd();
        ...
        static void SetResourceZip(int resourceID, const base::String& strResType = _T("ZIPRES"), LPCTSTR password = NULL);
	...
	private:
		...
		static base::String m_pStrResourcePath;
		static base::String m_pStrResourceZip;
		static base::String m_pStrResourceZipPwd;
