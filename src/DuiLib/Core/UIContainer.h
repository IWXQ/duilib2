...
namespace DuiLib {
	...
	public:
		...
		base::String GetSubControlText(LPCTSTR pstrSubControlName);
		int GetSubControlFixedHeight(LPCTSTR pstrSubControlName);
		int GetSubControlFixedWdith(LPCTSTR pstrSubControlName);
		const base::String GetSubControlUserData(LPCTSTR pstrSubControlName);
	...
	protected:
		...
		base::String	m_sVerticalScrollBarStyle;
		base::String	m_sHorizontalScrollBarStyle;
	};
