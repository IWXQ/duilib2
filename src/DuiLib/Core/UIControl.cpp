...
namespace DuiLib {
    ...
    base::String CControlUI::GetText() const {
        ...
        return CResourceManager::GetInstance()->GetText(m_sText.GetDataPointer());
    }
    ...
    LPCTSTR CControlUI::GetGradient() {
        return m_sGradient.GetDataPointer();
    }
    ...
    LPCTSTR CControlUI::GetBkImage() {
        return m_sBkImage.GetDataPointer();
    }
    ...
    LPCTSTR CControlUI::GetForeImage() const {
        return m_sForeImage.GetDataPointer();
    }
    ...
    base::String CControlUI::GetToolTip() const {
        ...
        return CResourceManager::GetInstance()->GetText(m_sToolTip.GetDataPointer());
    }

    void CControlUI::SetToolTip(LPCTSTR pstrText) {
        base::String strTemp(pstrText);
    ...
    const base::String &CControlUI::GetUserData() {
        return m_sUserData;
    }
    ...
    base::String CControlUI::GetVirtualWnd() const {
        base::String str;
    ...
    LPCTSTR CControlUI::GetCustomAttribute(LPCTSTR pstrName) const {
        ...
        base::String *pCostomAttr = static_cast<base::String *>(m_mCustomAttrHash.Find(pstrName));
    ...
    void CControlUI::RemoveAllCustomAttribute() {
		...
		for (std::map<base::String, LPVOID>::iterator it = m_mCustomAttrHash.Begin(); it != m_mCustomAttrHash.End(); it++) {
    ...
    void CControlUI::SetAttribute(LPCTSTR pstrName, LPCTSTR pstrValue) {
        ...
        if( _tcsicmp(pstrName, _T("pos")) == 0 ) {
            ...
            base::String sXmlData = pstrValue;
            sXmlData.Replace(_T("&quot;"), _T("\""));
            LPCTSTR pstrList = sXmlData.GetDataPointer();
            base::String sItem;
            base::String sValue;
            ...
            while( *pstrList != _T('\0') ) {
                ...
                SetAttribute(sItem.GetDataPointer(), sValue.GetDataPointer());
    ...
    void CControlUI::PaintForeImage(HDC hDC) {
        ...
        DrawImage(hDC, (LPCTSTR)m_sForeImage.GetDataPointer());
    }
