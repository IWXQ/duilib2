...
namespace DuiLib
{
	...
	protected:
		...
		base::String		m_sSelectedImage;
		base::String		m_sSelectedHotImage;
		base::String		m_sSelectedPushedImage;
		base::String		m_sSelectedForeImage;

		int m_nSelectedStateCount;
		base::String m_sSelectedStateImage;
	};
