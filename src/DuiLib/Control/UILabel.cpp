            ...
            if ((m_uTextStyle & DT_SINGLELINE) != 0) {
                ...
                if (m_cxyFixedLast.cx == 0) {
                    if(m_bAutoCalcWidth) {
                        ...
                        if( m_bShowHtml ) {
                            int nLinks = 0;
                            CRenderEngine::DrawHtmlText(m_pManager->GetPaintDC(), m_pManager, rcText, sText.GetDataPointer(), 0, NULL, NULL, nLinks, m_iFont, DT_CALCRECT | m_uTextStyle & ~DT_RIGHT & ~DT_CENTER);
                        } else {
                            CRenderEngine::DrawText(m_pManager->GetPaintDC(), m_pManager, rcText, sText.GetDataPointer(), 0, m_iFont, DT_CALCRECT | m_uTextStyle & ~DT_RIGHT & ~DT_CENTER);
                        }
