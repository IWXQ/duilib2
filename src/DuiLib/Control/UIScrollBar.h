...
namespace DuiLib
{
	...
	protected:
		...
		base::String m_sBkNormalImage;
		base::String m_sBkHotImage;
		base::String m_sBkPushedImage;
		base::String m_sBkDisabledImage;

		bool m_bShowButton1;
		RECT m_rcButton1;
		UINT m_uButton1State;
		base::String m_sButton1NormalImage;
		base::String m_sButton1HotImage;
		base::String m_sButton1PushedImage;
		base::String m_sButton1DisabledImage;

		bool m_bShowButton2;
		RECT m_rcButton2;
		UINT m_uButton2State;
		base::String m_sButton2NormalImage;
		base::String m_sButton2HotImage;
		base::String m_sButton2PushedImage;
		base::String m_sButton2DisabledImage;

		RECT m_rcThumb;
		UINT m_uThumbState;
		base::String m_sThumbNormalImage;
		base::String m_sThumbHotImage;
		base::String m_sThumbPushedImage;
		base::String m_sThumbDisabledImage;

		base::String m_sRailNormalImage;
		base::String m_sRailHotImage;
		base::String m_sRailPushedImage;
		base::String m_sRailDisabledImage;

		base::String m_sImageModify;
	};
}
