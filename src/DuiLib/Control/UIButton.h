...
namespace DuiLib {
    class UILIB_API CButtonUI : public CLabelUI {
      ...
      public:
		...
		virtual base::String GetFocusedForeImage() const;
		virtual void SetFocusedForeImage(LPCTSTR pStrImage);

		virtual base::String GetDisabledForeImage() const;
      ...
      protected:
        ...
        base::String m_sNormalImage;
        base::String m_sHotImage;
        base::String m_sHotForeImage;
		base::String m_sFocusedForeImage;
		base::String m_sDisabledForeImage;
        base::String m_sPushedImage;
        base::String m_sPushedForeImage;
        base::String m_sFocusedImage;
        base::String m_sDisabledImage;

        int         m_iBindTabIndex;
        base::String  m_sBindTabLayoutName;
    };
