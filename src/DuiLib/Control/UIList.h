...
#define UILIST_MAX_COLUMNS 32
    ...
    typedef struct tagTListInfoUI {
        ...
        base::String sBkImage;
        base::String sHotImage;
        base::String sDisabledImage;
        base::String sSelectedImage;
    } TListInfoUI;
    ...
    class UILIB_API CListHeaderItemUI : public CContainerUI {
      ...
      protected:
        ...
        base::String m_sSepImage;
        base::String m_sSepImageModify;
        int m_nScale;
    };
    ...
    class UILIB_API CListTextElementUI : public CListLabelElementUI {
      ...
      public:
        ...
        void SetOwner(CControlUI *pOwner);
        base::String *GetLinkContent(int iIndex);
