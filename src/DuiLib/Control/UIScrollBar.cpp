...
namespace DuiLib {
    ...
    LPCTSTR CScrollBarUI::GetButton1NormalImage() {
        return m_sButton1NormalImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetButton1HotImage() {
        return m_sButton1HotImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetButton1PushedImage() {
        return m_sButton1PushedImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetButton1DisabledImage() {
        return m_sButton1DisabledImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetButton2NormalImage() {
        return m_sButton2NormalImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetButton2HotImage() {
        return m_sButton2HotImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetButton2PushedImage() {
        return m_sButton2PushedImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetButton2DisabledImage() {
        return m_sButton2DisabledImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetThumbNormalImage() {
        return m_sThumbNormalImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetThumbHotImage() {
        return m_sThumbHotImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetThumbPushedImage() {
        return m_sThumbPushedImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetThumbDisabledImage() {
        return m_sThumbDisabledImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetRailNormalImage() {
        return m_sRailNormalImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetRailHotImage() {
        return m_sRailHotImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetRailPushedImage() {
        return m_sRailPushedImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetRailDisabledImage() {
        return m_sRailDisabledImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetBkNormalImage() {
        return m_sBkNormalImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetBkHotImage() {
        return m_sBkHotImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetBkPushedImage() {
        return m_sBkPushedImage.GetDataPointer();
    }
    ...
    LPCTSTR CScrollBarUI::GetBkDisabledImage() {
        return m_sBkDisabledImage.GetDataPointer();
    }
    ...
    void CScrollBarUI::PaintBk(HDC hDC) {
        ...
        if( (m_uThumbState & UISTATE_DISABLED) != 0 ) {
            if( !m_sBkDisabledImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sBkDisabledImage.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uThumbState & UISTATE_PUSHED) != 0 ) {
            if( !m_sBkPushedImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sBkPushedImage.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uThumbState & UISTATE_HOT) != 0 ) {
            if( !m_sBkHotImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sBkHotImage.GetDataPointer()) ) {}
                else return;
            }
        }

        if( !m_sBkNormalImage.IsEmpty() ) {
            if( !DrawImage(hDC, (LPCTSTR)m_sBkNormalImage.GetDataPointer()) ) {}
            else return;
        }
    }
    ...
    void CScrollBarUI::PaintButton1(HDC hDC) {
        ...
        if( (m_uButton1State & UISTATE_DISABLED) != 0 ) {
            if( !m_sButton1DisabledImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sButton1DisabledImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uButton1State & UISTATE_PUSHED) != 0 ) {
            if( !m_sButton1PushedImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sButton1PushedImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uButton1State & UISTATE_HOT) != 0 ) {
            if( !m_sButton1HotImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sButton1HotImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        }

        if( !m_sButton1NormalImage.IsEmpty() ) {
            if( !DrawImage(hDC, (LPCTSTR)m_sButton1NormalImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
            else return;
        }
    ...
    void CScrollBarUI::PaintButton2(HDC hDC) {
        ...
        if( (m_uButton2State & UISTATE_DISABLED) != 0 ) {
            if( !m_sButton2DisabledImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sButton2DisabledImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uButton2State & UISTATE_PUSHED) != 0 ) {
            if( !m_sButton2PushedImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sButton2PushedImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uButton2State & UISTATE_HOT) != 0 ) {
            if( !m_sButton2HotImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sButton2HotImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        }

        if( !m_sButton2NormalImage.IsEmpty() ) {
            if( !DrawImage(hDC, (LPCTSTR)m_sButton2NormalImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
            else return;
        }
    ...
    void CScrollBarUI::PaintThumb(HDC hDC) {
        ...
        if( (m_uThumbState & UISTATE_DISABLED) != 0 ) {
            if( !m_sThumbDisabledImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sThumbDisabledImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uThumbState & UISTATE_PUSHED) != 0 ) {
            if( !m_sThumbPushedImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sThumbPushedImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uThumbState & UISTATE_HOT) != 0 ) {
            if( !m_sThumbHotImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sThumbHotImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        }

        if( !m_sThumbNormalImage.IsEmpty() ) {
            if( !DrawImage(hDC, (LPCTSTR)m_sThumbNormalImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
            else return;
        }
    ...
    void CScrollBarUI::PaintRail(HDC hDC) {
        ...
        if( (m_uThumbState & UISTATE_DISABLED) != 0 ) {
            if( !m_sRailDisabledImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sRailDisabledImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uThumbState & UISTATE_PUSHED) != 0 ) {
            if( !m_sRailPushedImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sRailPushedImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        } else if( (m_uThumbState & UISTATE_HOT) != 0 ) {
            if( !m_sRailHotImage.IsEmpty() ) {
                if( !DrawImage(hDC, (LPCTSTR)m_sRailHotImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
                else return;
            }
        }

        if( !m_sRailNormalImage.IsEmpty() ) {
            if( !DrawImage(hDC, (LPCTSTR)m_sRailNormalImage.GetDataPointer(), (LPCTSTR)m_sImageModify.GetDataPointer()) ) {}
            else return;
        }
    }
}
