...
#include <textserv.h>
    ...
    base::String CRichEditUI::GetText() const {
    ...
    base::String CRichEditUI::GetSelText() const {
        if( !m_pTwh ) return base::String();
    ...
    base::String CRichEditUI::GetTextRange(long nStartChar, long nEndChar) const {
        TEXTRANGEW tr = { 0 };
    ...
    base::String CRichEditUI::GetLine(int nIndex, int nMaxLength) const {
        LPWSTR lpText = NULL;
    ...
    void CRichEditUI::DoInit() {
        ...
        cs.cy = 0;
        cs.cx = 0;
        cs.lpszName = m_sText.GetDataPointer();
    ...
    bool CRichEditUI::DoPaint(HDC hDC, const RECT &rcPaint, CControlUI *pStopControl) {
        ...
        if(sDrawText.IsEmpty() && !m_bFocused) {
            ...
            CRenderEngine::DrawText(hDC, m_pManager, rc, sTipValue.GetDataPointer(), dwTextColor, m_iFont, uTextAlign);
        }
    ...
    LPCTSTR CRichEditUI::GetTipValue() {
        return m_sTipValue.GetDataPointer();
    }
