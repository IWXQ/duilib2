...
namespace DuiLib {
	...
	public:
		...
		base::String GetTextRange(long nStartChar, long nEndChar) const;
		...
		base::String GetLine(int nIndex, int nMaxLength) const;
