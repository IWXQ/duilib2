...
namespace DuiLib {
	...
	public:
		...
		base::String GetDropBoxAttributeList();
	...
	protected:
        ...
        SIZE m_szDropBox;
        base::String m_sDropBoxAttributes;

        base::String m_sArrowNormalImage;
        base::String m_sArrowHotImage;
        base::String m_sArrowPushedImage;
        base::String m_sArrowFocusedImage;
        base::String m_sArrowDisabledImage;
	};
