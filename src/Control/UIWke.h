...
namespace DuiLib {
    ...
    public:
        ...
        void SetUrl(const CDuiString& strUrl);
        void SetBkImage(const CDuiString& strBkImage);
        void ShowDevTools();
        void GoForward();
        void GoBack();
        void Reload();
    ...
    public:
        ...
        void SetURL(const CDuiString& strValue);
        void SetBkImage(const CDuiString& strValue);
        VARIANT CallJavascriptFunction(const std::string &strFuncName, const std::vector<VARIANT> &vars);
